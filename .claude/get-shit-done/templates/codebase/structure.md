...
- Usage: Reference from command with `@C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
