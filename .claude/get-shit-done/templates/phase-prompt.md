...
<!-- For checkpoint task examples and patterns, see @C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/get-shit-done/references/checkpoints.md -->
...
See `C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
