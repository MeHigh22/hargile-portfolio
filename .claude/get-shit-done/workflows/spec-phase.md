...
```bash
INIT=$(node "C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/get-shit-done/templates/spec.md.
