...
```
Task(
  prompt="Read C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/get-shit-done/templates/SECURITY.md`
