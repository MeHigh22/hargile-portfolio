...
Key references:
- @C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/get-shit-done/references/ui-brand.md (display patterns)
- @C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/get-shit-done/agents/gsd-user-profiler.md (profiler agent definition)
- @C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/get-shit-done/USER-PROFILE.md"
...
```bash
cp "C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/get-shit-done/USER-PROFILE.md" "C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/get-shit-done/references/user-profiling.md`
...
Reference: @C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/commands/gsd/dev-preferences.md"
...
Display: "✓ Added profile section to C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/commands/gsd/dev-preferences.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/CLAUDE.md
```
