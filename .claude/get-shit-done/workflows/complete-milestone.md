...
```bash
node "C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/get-shit-done/templates/retrospective.md`.
