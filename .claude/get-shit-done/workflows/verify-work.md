...
<template>
@C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/get-shit-done/templates/UAT.md
</template>
...
Read and follow `C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/get-shit-done/workflows/transition.md`.
...
```bash
node "C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/get-shit-done/bin/gsd-tools.cjs" audit-open --json 2>/dev/null
```
...
- Follow @C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/get-shit-done/workflows/diagnose-issues.md
