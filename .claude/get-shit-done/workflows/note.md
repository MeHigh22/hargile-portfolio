...
- **Global scope**: `C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/notes/`)
...
2. Glob `C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/notes/*.md` (if directory exists) — global notes
...
Global (C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/notes/` — works in any directory
