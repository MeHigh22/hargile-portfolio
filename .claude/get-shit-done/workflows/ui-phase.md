...
```markdown
Read C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/agents/gsd-ui-checker.md for instructions.
