...
Project root: ${CWD}
Prefer: gsd-sdk query <subcommand> (installed gsd-sdk on PATH). Legacy: node C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/get-shit-done/bin/gsd-tools.cjs
