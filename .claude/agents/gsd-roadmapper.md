...
Reference full template: `C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/get-shit-done/templates/state.md`.
