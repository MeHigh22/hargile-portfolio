...
<reference>
@C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/get-shit-done/references/user-profiling.md` to load:
