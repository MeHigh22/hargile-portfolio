...
Use template from `C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/get-shit-done/templates/UI-SPEC.md`
