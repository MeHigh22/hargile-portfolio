...
<required_reading>
Read `C:/Argent/Hargile Portfolio/hargile-portfolio/.claude/get-shit-done/references/ai-evals.md` — specifically the rubric design and domain expert sections.
</required_reading>
