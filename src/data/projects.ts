...
export const projects: ProjectData[] = [
  ...
  },
  {
    ...
    category: 'Application Mobile',
    year: '2026',
    subtitle: 'Banque, fiscalite et facturation pour freelances.',
    client: 'Koi Financial',
    services: 'UI/UX, Developpement, Backend',
    duration: '8 mois',
    tech: 'React Native Web, Rails, PostgreSQL, Stripe',
    heroImg: 'https://images.unsplash.com/photo-1563013544-824ae1b704d3?h=900&fit=crop&q=85',
    colors: { accent: '#95B8F8', background: '#06080d', gradientFrom: '#95B8F8', gradientTo: '#b896f7' },
    ambience: 'grid',
    imageRatio: 'balanced',
    industry: 'Fintech',
    narrative: {
      problem: "Les freelances jonglaient entre 4 outils. TVA oubliee, tresorerie floue, temps perdu.",
      solution: "App web React Native Web avec moteur de regles fiscales FR, facturation integree et vue tresorerie temps reel.",
      outcome: "4 200 utilisateurs actifs en 8 mois, NPS 62.",
    },
  },
  {
    id: 'verso',
    ...
    year: '2026',
    subtitle: 'Un journal numerique qui se lit lentement.',
    client: 'Verso Journal',
    services: 'UI/UX, Developpement, Editorial',
    duration: '4 mois',
    tech: 'Astro, MDX, Vercel',
    heroImg: 'https://images.unsplash.com/photo-1504711434969-e33886168f5c?h=900&fit=crop&q=85',
    colors: { accent: '#95B8F8', background: '#06080d', gradientFrom: '#95B8F8', gradientTo: '#b896f7' },
    ambience: 'grid',
    imageRatio: 'balanced',
    industry: 'Media',
    narrative: {
      problem: "Un site editorial avec pubs envahissantes, temps de lecture moyen en chute libre.",
      solution: "Refonte sans pub, grille inspiree de la presse 70s. Lecteur Astro + MDX, performances 100/100 Lighthouse.",
      outcome: "+310 % d'abonnes payants, temps lecture 7:12 sur mobile.",
    },
  },
  {
    id: 'helios',
    ...
    category: 'E-commerce',
    year: '2026',
    subtitle: 'Shop en ligne et abonnement cafe.',
    client: 'Helios Brew',
    services: 'UI/UX, Developpement, Shopify',
    duration: '4 mois',
    tech: 'Shopify Hydrogen, Remix, Stripe',
    heroImg: 'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?h=900&fit=crop&q=85',
    colors: { accent: '#95B8F8', background: '#06080d', gradientFrom: '#95B8F8', gradientTo: '#b896f7' },
    ambience: 'grid',
    imageRatio: 'balanced',
    industry: 'E-commerce',
    narrative: {
      problem: "Un Shopify par defaut, panier moyen stagnant, pas d'abonnement.",
      solution: "Theme Shopify Hydrogen sur-mesure, moteur d'abonnement maison, storytelling produit riche.",
      outcome: "Panier moyen x2.4 ; 38 % du CA en abonnement recurrant apres 4 mois.",
    },
  },
  {
    id: 'verde',
