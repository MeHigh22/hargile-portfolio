      ...
      <section ref={ref as React.Ref<HTMLElement>} className={['outro portfolio-slide', className].filter(Boolean).join(' ')}>
        ...
        <div className="right-col stagger">
          <dl className="contact">
            ...
            <dt>Contact</dt>
            <dd>
              <a href="mailto:charles.dl@hargile.com">charles.dl@hargile.com</a>
              <br />
          ...
          <div className="socials">
            ...
            <a href="https://www.youtube.com/@HARGILEinnovativesolutions" target="_blank" rel="noreferrer" title="YouTube">
            ...
            <a href="https://github.com/HARGILE-innovative-solutions" target="_blank" rel="noreferrer" title="GitHub">
            ...
            <a href="https://www.google.com/maps/place/HARGILE+innovative+solutions/@50.8274228,4.3401395,17z" target="_blank" rel="noreferrer" title="Maps">
